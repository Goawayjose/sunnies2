...
<img class="LandingImg" src="<?php the_field('mainLanding'); ?>" alt="">
<?php endwhile; else: ?>
...
<div class="bigHeader">
	...
	<h1>SUNNIES</h1>
	<h4>Pick a style and a lens, we'll handle the rest.</h4>
