...
<div class="container">
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <div class="row">
          <div class="col-md-6">
            <img src="<?php the_field('imgMain'); ?>" alt="">
          </div>
          <div class="col-md-6">
            <h1><?php the_title(); ?></h1>

            <h4><?php echo get_the_date(); ?> by <?php the_author(); ?></h4>


           <?php the_content(); ?>
           <div class="">
             <h5>Categories:
             <?php the_category(', ') . " " . the_tags(__('Tags: '), ', ', ' | ') . edit_post_link(__('Edit'), ''); ?></h5>

           </div>
           <div class="single btn-select">
             <p>select lens</p>
           </div>
          </div>
